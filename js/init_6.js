...
var defaut_font = "15px 黑体"
var defaut_color = "rgb(0,0,250)"
var defaut_textAlign = "center"
var screen_width = window.screen.availWidth
var screen_height = window.screen.availHeight
var y_rate = screen_height / 736
var x_rate = screen_width / 414
var delay_px = 0
...
var texts = [
    ...
    [
        {'text':screen_height+'*'+screen_width, 'x':0, 'y':-150,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
         {'text': 'x:'+(screen_width/2-160-delay_px) + 'y:' + (screen_height/2-112-delay_px), 'x':-160-delay_px, 'y':-112-delay_px,'color': 'rgb(80,10,50)', 'textAlign': 'left'},
        //{'text':'| 2015年 8134', 'x':-screen_width/2+80*x_rate, 'y':-screen_height/2+242*y_rate+50,'font': '14px lighter','color': 'rgb(80,10,50)'},
        //{'text':'| 2015年 8134', 'x':-screen_width/2+80*x_rate, 'y':-screen_height/2+242*y_rate+100,'font': '14px lighter','color': 'rgb(80,10,50)'},
        //{'text':'| 2015年 8134', 'x':-screen_width/2+80*x_rate, 'y':-screen_height/2+242*y_rate+150,'font': '14px lighter','color': 'rgb(80,10,50)'},
        //{'text':'| 2015年 8134', 'x':-screen_width/2+80*x_rate, 'y':-screen_height/2+242*y_rate+200,'font': '14px lighter','color': 'rgb(80,10,50)'},
    ], 
    [
        {'text':'3地图', 'x':160, 'y':137,'font': '30px 黑体','color': 'rgb(120,250,80)'},
        {'text':'默认格式-2019年各区', 'x':203, 'y':556},
    ],
    [
        {'text':'2019年佛山产业结构', 'x':160, 'y':200,'font': '18px 黑体','color': 'rgb(12,25,80)','textAlign': 'center'},
        {'text':'第一产业', 'x':303, 'y':506,'color': 'rgb(0,0,0)'},
        {'text':'第二产业', 'x':303, 'y':286,'color': 'rgb(0,0,0)'},
        {'text':'第三产业', 'x':153, 'y':286,'color': 'rgb(0,0,0)'},
    ],
    [
        {'text':'佛山市实有各类市场主体', 'x':160, 'y':200,'font': '18px 黑体','color': 'rgb(12,25,80)','textAlign': 'center'},
        {'text':'企业', 'x':123, 'y':496,'color': 'rgb(0,0,0)'},
        {'text':'个体户', 'x':303, 'y':496,'color': 'rgb(0,0,0)'},
    ],
    [
        {'text':'7地图', 'x':160, 'y':126,'font': '40px 黑体','color': 'rgb(99,125,10)'},
    ],
    [
        {'text':'8GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
        {'text':'9GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
        {'text':'10GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
        {'text':'11GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
        {'text':'12GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
        {'text':'13GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
        {'text':'14GDP', 'x':160, 'y':56,'font': '40px 黑体','color': 'rgb(99,5,10)'},
    ],
    [
